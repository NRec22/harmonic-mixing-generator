...
function listCompatible(playlist, num, key){
    var newList = [];
...
// console.log(listCompatible(initialPlaylist, 7, "m"));
//
...
// console.log("Compatible with first song");
// console.log(listCompatible(initialPlaylist2, 12, "m"));
//
...
// console.log("Compatible with first song");
// console.log(listCompatible(initialPlaylist3, 4, "d"));
//
